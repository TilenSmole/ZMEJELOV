...
class M4_yellow extends M0_shared {
    constructor() {
        super("M4_yellow")
    }
	...
	createRectanglePlatform(x, y) {
		...
		var rectColor = 0xFFFACD;  // Color of the rectangle
    ...
    update() {
        ...
        if (canStart) { //cleaning
            ...
            if (gameState.junak.x >= 14500) {
                this.reset()

                this.scene.stop('M4_yellow');
                this.scene.start('M4_green');
