...
class M4_indigo extends M0_shared {
    constructor() {
        super("M4_indigo")
    }
	...
	createRectanglePlatform(x, y) {
		...
		var rectColor = 0x6E329B;  // Color of the rectangle
