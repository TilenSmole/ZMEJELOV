...
class M4_green extends M0_shared {
    constructor() {
        super("M4_green")
    }
    dolzina = 15000
    ...
    createRectanglePlatform(x, y) {
		...
		var rectColor = 0x002300;  // Color of the rectangle
    ...
    update() {
        ...
        if (canStart) { //cleaning
            ...
            if (gameState.junak.x >= 14500) {
                ...
                this.scene.stop('M4_green');
                this.scene.start('M4_blue');
