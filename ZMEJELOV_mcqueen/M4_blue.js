...
class M4_blue extends M0_shared {
    constructor() {
        super("M4_blue")
    }   
     dolzina = 12000
    ...
    createRectanglePlatform(x, y) {
		...
		var rectColor = 0x3232FF;  // Color of the rectangle
    ...
    update() {
        ...
        if (canStart) { 
            ...
            if (gameState.junak.x >= 11500) {
                this.reset()

                this.scene.stop('M4_blue');
                this.scene.start('M4_indigo');
