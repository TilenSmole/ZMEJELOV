class E0_poker extends Phaser.Scene {
    constructor() {
        super({ key: 'E0_poker' });
    }
    preload() {
    ...
    create() {
        ...
        var vrstaL = Math.floor(Math.random() * 4);


        var levaKarta = this.add.image(GAME_WIDTH / 2 - 200, GAME_HEIGHT / 2, vsi[vrstaL][leva])
        levaKarta.setScale(.5)


        var desna = Math.floor(Math.random() * 13) + 2;
        // this.add.text(GAME_WIDTH/2+100,GAME_HEIGHT-100, desna,{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });
        ...
        //this.add.text(GAME_WIDTH/2+400,GAME_HEIGHT-100, desna,{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });
        ...
        if (leva == desna) {
            this.vecji.on('pointerup', () => {
                ...
                leva = desna
                vrstaLeva = vrstaD
                //this.add.text(GAME_WIDTH/2-100,GAME_HEIGHT/2-140, desna,{ fontSize: '20px',  fill: '#E950F4',fontFamily: 'CustomFont' });
                ...
                this.next.on('pointerup', () => {
                    this.scene.stop('E0_poker')
                    this.scene.start('E0_poker1')
                })
            })
